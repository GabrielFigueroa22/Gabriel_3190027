...
function mostrarMenu() {
    ...
    menu += (productos.length + 2) + ". Agregar al Carrito\n"; // Nueva opción para agregar productos
...
do {
    ...
    if (isNaN(opcion) || opcion < 1 || opcion > productos.length + 3) {
        ...
        var productoIndex = prompt("Ingrese el número del producto que desea agregar:");
        agregarAlCarrito(productoIndex - 1);
    }
